...
it('inspects the brazilian tech job boards fixture source without importing leads', function (): void {
    ...
    $this->artisan('discovery:inspect-source', [
        ...
        ->expectsOutput('Skipped by query: 4')
        ->expectsOutput('Normalized query: laravel')
        ->expectsOutput('Target ProgramaThor (programathor): fetched 5 · matched 1 · query-skipped 2 · expired 1 · missing company 1 · failed 0')
        ->expectsOutput('Target Remotar (remotar): fetched 3 · matched 0 · query-skipped 2 · expired 1 · missing company 0 · failed 0')
        ->assertExitCode(0);
});
...
it('uses resume-derived query profiles while inspecting the brazilian tech job boards fixture source', function (): void {
    ...
    $this->artisan('discovery:inspect-source', [
        ...
        ->expectsOutput('Target Remotar (remotar): fetched 3 · matched 2 · query-skipped 0 · expired 1 · missing company 0 · failed 0')
        ->assertExitCode(0);
});
