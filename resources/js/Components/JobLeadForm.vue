...
<template>
    <form @submit.prevent="$emit('submit')" class="space-y-6">
        <div class="rounded-3xl border border-gold-300/15 bg-gradient-to-br from-gold-400/8 via-white/[0.03] to-transparent p-6">
            <div>
                <label for="source_url" class="premium-input-label">Job URL</label>
                <p class="mt-2 text-sm leading-7 text-slateglass-300">
                    You can start with just the job URL. URL-only intake saves the lead. Paste the job description below to extract keywords now.
                </p>
                <TextInput
                    id="source_url"
            ...
            >
                <label for="description_text" class="premium-input-label">Paste job description (optional)</label>
                <p class="mt-2 text-sm leading-7 text-slateglass-300">
                    Paste the job text here to extract keywords and improve matching immediately
                </p>
                <textarea
                    id="description_text"
                    ...
                    placeholder="Paste the job text here if you want ATS keyword analysis right away."
                />
                ...
                <p class="mt-3 text-xs uppercase tracking-[0.16em] text-slateglass-400">
                    URL-only intake does not parse job pages automatically yet.
                </p>
            </div>
        </div>
        ...
        >
            ...
            <div class="mt-6 grid gap-6 md:grid-cols-2">
                <div>
                    ...
                    <TextInput
                        ...
                        type="text"
                        class="mt-2 block w-full"
                        placeholder="Optional. Derived from the URL if empty."
                    />
                ...
                <div>
                    ...
                    <TextInput
                        ...
                        type="text"
                        class="mt-2 block w-full"
                        placeholder="Optional. Imported job is used if empty."
                    />
            ...
            >
                ...
                <p class="mt-2 text-sm text-slateglass-300">
                    Optional. Paste the full job description to extract keywords and optimize your resume.
                </p>
                <textarea
                    id="description_text"
                    v-model="form.description_text"
                ...
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slateglass-400">
                            Optional. Keep your private observations separate from the ATS analysis input.
                        </p>
                    </div>
                    <span class="rounded-full border border-white/10 bg-black/20 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-slateglass-400">
                        Notes
