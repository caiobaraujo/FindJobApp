...
$fixtureGupyPublicJobTargets = [
    ...
    [
        'name' => 'Gupy Tech',
        'parser_strategy' => 'gupy_listing',
        'listing_url' => 'https://tech-career.gupy.io/',
    ],
    [
        'name' => 'Vsoft Tecnologia',
        'parser_strategy' => 'gupy_listing',
        'listing_url' => 'https://vsoft.gupy.io/',
    ],
    [
        'name' => 'Teltex Tecnologia',
        'parser_strategy' => 'gupy_listing',
        'listing_url' => 'https://teltex.gupy.io/',
    ],
    [
        'name' => 'Pmweb',
        'parser_strategy' => 'gupy_listing',
        'listing_url' => 'https://pmweb.gupy.io/',
    ],
    [
        'name' => 'Grupo Autoglass Administrativo',
        'parser_strategy' => 'gupy_listing',
...
return [
    ...
    'fixture_responses' => [
        ...
        'gupy_public_jobs' => [
            ...
            'https://tech-career.gupy.io/' => base_path('tests/Fixtures/gupy_public_jobs_gupy_tech_listing.html'),
            'https://tech-career.gupy.io/jobs/10701863' => base_path('tests/Fixtures/gupy_public_jobs_gupy_tech_fullstack_detail.html'),
            'https://vsoft.gupy.io/' => base_path('tests/Fixtures/gupy_public_jobs_vsoft_listing.html'),
            'https://vsoft.gupy.io/jobs/10180944' => base_path('tests/Fixtures/gupy_public_jobs_vsoft_systems_detail.html'),
            'https://teltex.gupy.io/' => base_path('tests/Fixtures/gupy_public_jobs_teltex_listing.html'),
            'https://teltex.gupy.io/jobs/11234001' => base_path('tests/Fixtures/gupy_public_jobs_teltex_noc_detail.html'),
            'https://pmweb.gupy.io/' => base_path('tests/Fixtures/gupy_public_jobs_pmweb_listing.html'),
